...
-- Keep only the secure, specific policies
-- Note: The other policies (admin and user-specific) should remain

-- Fix the broken is_user_verified function
DROP FUNCTION IF EXISTS public.is_user_verified(uuid);
