...
export type Database = {
  public: {
    Tables: {
      ...
      conversations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "conversations_load_id_fkey"
            columns: ["load_id"]
            isOneToOne: false
            referencedRelation: "loads"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "conversations_shipper_id_fkey"
            columns: ["shipper_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
      ...
      verification_files: {
        ...
        Relationships: [
          {
            foreignKeyName: "verification_files_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "verification_files_verified_by_fkey"
            columns: ["verified_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_loads_within_radius: {
        Args: { driver_location: unknown; radius_miles?: number }
        Returns: {
          assigned_driver_id: string | null
          created_at: string | null
          delivery_deadline: string | null
    ...
    Enums: {
      ...
      transaction_type: "payment" | "payout" | "platform_fee" | "insurance_fee"
      user_role: "shipper" | "driver" | "admin"
      user_status: "active" | "suspended" | "pending"
      user_type: "driver" | "shipper" | "admin"
